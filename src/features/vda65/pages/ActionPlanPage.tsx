...
export default function Vda65ActionPlanPage() {
  const { actionPlanItems, updateActionPlanItem, saveActionPlanItem } = useVda65AuditWorkspace()
  ...
  return (
    <div className="module-page">
      <PageHeader
        ...
        eyebrowTone="vda65"
        title="Action plan"
        subtitle="Corrective-action tracking for product audit defects, containment steps, root cause analysis, owners, effectiveness checks, and closure notes."
      />
